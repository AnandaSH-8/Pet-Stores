...
import {createBoard} from "../Redux/Board/actions"
...
export const Create = () =>{
   ...
   const [state,dispatch] = useReducer(petReducer,initState)
    ...
    <div className="topbar">
        ...
        onClick={()=>{ReduxDispatch(createBoard(state))}}>Submit</Button>
    </div>
    ...
    <div style={{width:"34%"}} className="forms">
        <FormControl className="FormControl" style={{width:"95%"}}>
            <Stack spacing={5}>
                ...
                <Textarea style={InputStyle} placeholder='About Pet service'
